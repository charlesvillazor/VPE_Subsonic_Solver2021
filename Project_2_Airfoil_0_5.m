...
%April 28th, 2021
%MAE 456
%Final Project Part 2 - Airfoil Mach 0.5
clc;clear;close all
...
%% Airfoil Velocity Potential (Mach 0.5)
mach = 0.5; %mach number at freestream
...
%% Boundary Conditions for Velocity Potential (Mach 0.5)
%far field
i = 1;
for j = 1:Ny+1
    phi(i,j) = u_inf*xcenter(i,j)+v_inf*ycenter(i,j);
...
%% Alternate Airfoil Grad (Mach 0.5)
%Taken from website
for j = 2:Ny
    for i = 2:Nx
...
%% Contour plot of u component of Airfoil velocity (Mach 0.5)
figure(2)
...
colorbar;
axis equal
title('Airfoil Contour Plot of u component of Velocity (Mach 0.5)')
xlabel('X Distance')
ylabel('Y Distance')

%% Contour plot of v component of Airfoil velocity (Mach 0.5)
figure(3)
contourf(xcenter(2:Nx,2:Ny),ycenter(2:Nx,2:Ny),-grad(2:Nx,2:Ny,2),100,'edgecolor','none');
colorbar;
axis equal
title('Airfoil Contour Plot of v component of Velocity (Mach 0.5)')
xlabel('X Distance')
ylabel('Y Distance')

%% Calculating Airfoil Rho (Mach 0.5)
for i = 1:Nx+1
    for j = 1:Ny+1
...
colorbar;
axis equal
title('Airfoil Contour Plot of u component of Velocity (Mach 0.5)(After Iterating)')
xlabel('X Distance')
ylabel('Y Distance')
...
colorbar;
axis equal
title('Airfoil Contour Plot of v component of Velocity (Mach 0.5)(After Iterating)')
xlabel('X Distance')
ylabel('Y Distance')
...
title('Coefficient of Pressure vs x/c Plot - Along Airfoil (Mach 0.5)')
ylabel('C_p')
xlabel('x/c')
...
title('Mach Number Distribution along Airfoil (Mach 0.5)')
xlabel('x/c')
ylabel('Mach Number')
...
colorbar;
axis equal
title('Airfoil Contour Plot of Magnitude of Velocity (Mach 0.5)(After Iterating)')
xlabel('X Distance')
ylabel('Y Distance')
