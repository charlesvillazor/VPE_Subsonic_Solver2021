...
%April 28th, 2021
%MAE 456
%Final Project Part 2 - Channel Mach 0.5
clc;clear;close all
...
%% Channel Velocity Potential (Mach 0.5)
mach = 0.51; %mach number at freestream
...
%% Boundary Contitions for Channel Phi (Mach 0.5)
%lecture 21 slide 6
%Channel Inflow
i = 1;
for j = 2:Ny
...
%% Alternate Channel Grad (Mach 0.5)
%Taken from website
for j = 2:Ny
    for i = 2:Nx
...
%% Boundary Conditions for Channel Grad (Mach 0.5)
%lecture 21 slide 6
%Channel Inflow
i = 1;
for j = 2:Ny
...
%% Contour plot of u component of Channel velocity (Mach 0.5)
figure(2)
...
colorbar;
axis equal
title('Channel Contour Plot of u component of Velocity (Mach 0.5)')
xlabel('X Distance')
ylabel('Y Distance')

%% Contour plot of v component of Channel velocity (Mach 0.5)
figure(3)
contourf(xcenter(2:Nx,2:Ny),ycenter(2:Nx,2:Ny),-grad(2:Nx,2:Ny,2),100,'edgecolor','none');
colorbar;
axis equal
title('Channel Contour Plot of v component of Velocity (Mach 0.5)')
xlabel('X Distance')
ylabel('Y Distance')

%% Calculating Channel Rho (Mach 0.5)
for i = 1:Nx+1
    for j = 1:Ny+1
...
colorbar;
axis equal
title('Channel Contour Plot of u component of Velocity (Mach 0.5)(After Iterating)')
xlabel('X Distance')
ylabel('Y Distance')
...
colorbar;
axis equal
title('Channel Contour Plot of v component of Velocity (Mach 0.5)(After Iterating)')
xlabel('X Distance')
ylabel('Y Distance')

%% Calculating Pressure (Mach 0.5)
for i = 1:Nx+1
    for j = 1:Ny+1
...
%% Calculating Pressure Coefficient (Mach 0.5)
for i = 1:Nx+1
    for j = 1:Ny+1
...
figure(7)
plot((xcenter(2:Nx,1)/max(xcenter(2:Nx,1))),cp(2:Nx,1));
title('Coefficient of Pressure vs x/c Plot - Top Wall (Mach 0.5)')
ylabel('C_p')
xlabel('x/c')
...
title('Coefficient of Pressure vs x/c Plot - Bottom Wall (Mach 0.5)')
ylabel('C_p')
xlabel('x/c')
...
title('Mach Number Distribution along top Slip Wall')
xlabel('x/c')
ylabel('Mach Number')
...
colorbar;
axis equal
title('Channel Contour Plot of Magnitude of Velocity (Mach 0.5)(After Iterating)')
xlabel('X Distance')
ylabel('Y Distance')